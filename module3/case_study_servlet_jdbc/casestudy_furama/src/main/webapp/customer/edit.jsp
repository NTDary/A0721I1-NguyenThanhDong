                    ...
                    <tr>
                        ...
                        <td>
                            <select class="custom-select mr-sm-2" name="id_type" id="inlineFormCustomSelect">
                                ...
                                <option value="<c:out value='${customer.customer_type_id}'/>">Diamond</option>
                                <option value="<c:out value='${customer.customer_type_id}'/>">Platinium</option>
                                <option value="<c:out value='${customer.customer_type_id}'/>">Gold</option>
                                <option value="<c:out value='${customer.customer_type_id}'/>">Silver</option>
                                <option value="<c:out value='${customer.customer_type_id}'/>">Member</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="gender" value="<c:out value="${customer.customer_gender}"/>">
