...
<html lang="en">
<head>
    <title>TComplex DashBoard</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link" href="tcomplex">Mặt Bằng Thuê</a>
            </li>
            <li class="nav-item">
            ...
            <form method="post">
                <table border="1" cellpadding="5">
                    <tr>
                        <th>Mã mặt bằng(*)</th>
                        <td>
                            <input type="text" class="form-control" name="ma_mat_bang" required>
                            <%--                            <p>${name}</p>--%>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>Trạng thái(*)</th>
                        <td>
                            <select class="custom-select mr-sm-2" name="trang_thai" required>
                    ...
                    <tr>
                        <th>Tầng(*)</th>
                        <td>
                            <select class="custom-select mr-sm-2" name="tang" required>
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="custom-select mr-sm-2" name="loai_van_phong" required>
                    ...
                    <tr>
                        <th>Giá cho thuê(*)</th>
                        <td>
                            <input type="text" class="form-control" name="gia_thue" required>
                        </td>
                    </tr>
                    <tr>
                        <th>Ngày bắt đầu(*)</th>
